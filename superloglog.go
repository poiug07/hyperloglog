...
func (sll *SuperLogLog[T]) GetCount() uint64 {
	...
	// I use value generated by this guy, bit doesn't make sense in my case,
	// cause it underestimating severely https://github.com/ethantrott/hyperloglog-estimation
	return uint64(math.Round(float64(sll.m_zero) * sll.a_m * math.Pow(2, avg)))
}
